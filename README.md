...
<p align='center'>
Notable moments here are the creation of the geomap using the ZIP codes, the inclusion of KPIs to add notable numbers, and the color alignment with the NYC Health schematics.
</p>
